...
export async function renderAppearance(root) {
  ...
  <div class="panel">
    ...
    <div class="form-grid">
      <div class="form-row"><label>Cor principal</label><div class="color-input"><input type="color" id="c_primary" value="${cfg.primary||'#9c3d1c'}" /><input type="text" id="c_primary_t" value="${cfg.primary||'#9c3d1c'}" /></div></div>
      <div class="form-row"><label>Cor secundária (destaque)</label><div class="color-input"><input type="color" id="c_accent" value="${cfg.accent||'#a07a2f'}" /><input type="text" id="c_accent_t" value="${cfg.accent||'#a07a2f'}" /></div></div>
      <div class="form-row"><label>Cor dos botões</label><div class="color-input"><input type="color" id="c_button" value="${cfg.buttonColor||'#9c3d1c'}" /><input type="text" id="c_button_t" value="${cfg.buttonColor||'#9c3d1c'}" /></div></div>
      <div class="form-row"><label>Cor de fundo</label><div class="color-input"><input type="color" id="c_bg" value="${cfg.bg||'#f6f1ea'}" /><input type="text" id="c_bg_t" value="${cfg.bg||'#f6f1ea'}" /></div></div>
    </div>
