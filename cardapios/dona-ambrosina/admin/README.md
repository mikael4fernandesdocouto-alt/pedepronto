# Painel Administrativo — Dona Ambrosina
...
2. Copie os valores e preencha em `firebase-config.js`:
   ...
   ```
3. O `RESTAURANT_ID = "dona-ambrosina"` já está configurado. **Não altere**.
...
No documento `restaurants/dona-ambrosina/settings/info`, crie/adicione:
```json
{
...
├── css/
│   ├── style.css        (estilo do painel, paleta vinho + dourado)
